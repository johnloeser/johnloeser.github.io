...
$$ h(x) \approx \frac{h(x_{1}) - h(x_{0})}{x_{1} - x_{0}} + h(x_{0}) $$

We can then solve $$ h(x) = 0 $$ using our approximation. Which gives us a new guess $$ x_{2} $$.
